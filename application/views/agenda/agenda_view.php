					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>ID DESIGN CHANGE: </b>
					        <input type="text" class="form-control"  name="id_dc" id="id_dc" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>Nor - No: </b>
					        <input type="text" class="form-control"  name="nor_no" id="nor_no" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>Rev: </b>
					        <input type="text" class="form-control"  name="v_rev" id="v_rev" disabled />
					      </div>
						</div>
					</div>
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>Carline: </b>
					        <input type="text" class="form-control"  name="v_carline" id="v_carline" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>Item Changes: </b>
					        <input type="text" class="form-control"  name="v_item_changes" id="v_item_changes" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>Implemented Date: </b>
					        <input type="text" class="form-control"  name="v_start" id="v_start" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>DE - EPL: </b>
					        <input type="text" class="form-control"  name="v_de_epl" id="v_de_epl" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>DE-COMM CCT, TUBE: </b>
					        <input type="text" class="form-control"  name="v_de_com" id="v_de_com" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>DE-ENG DWG: </b>
					        <input type="text" class="form-control"  name="v_de_eng" id="v_de_eng" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>NYS-KANBAN CCT: </b>
					        <input type="text" class="form-control"  name="v_nys_kb_cct" id="v_nys_kb_cct" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>NYS-KANBAN MATERIAL: </b>
					        <input type="text" class="form-control"  name="v_nys_kb_material" id="v_nys_kb_material" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>NYS-MCL: </b>
					        <input type="text" class="form-control"  name="v_nys_mcl" id="v_nys_mcl" disabled />
					      </div>
						</div>
					</div>	  
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>PP-SWCT: </b>
					        <input type="text" class="form-control"  name="v_pp_swct" id="v_pp_swct" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>PP-MATRIK: </b>
					        <input type="text" class="form-control"  name="v_pp_matrik" id="v_pp_matrik" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>QP-SWCT: </b>
					        <input type="text" class="form-control"  name="v_qp_swct" id="v_qp_swct" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>QP-DWG INSPEK: </b>
					        <input type="text" class="form-control"  name="v_qp_dwg" id="v_qp_dwg" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>PPC-REQ PRICE: </b>
					        <input type="text" class="form-control"  name="v_ppc_req" id="v_ppc_req" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>PPC-RELEASE: </b>
					        <input type="text" class="form-control"  name="v_ppc_release" id="v_ppc_release" disabled />
					      </div>
						</div>
					</div>					
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>PROD-IMPLEMENTASI: </b>
					        <input type="text" class="form-control"  name="v_prod_imp" id="v_prod_imp" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>PROD-PENGOSONGAN WIP: </b>
					        <input type="text" class="form-control"  name="v_prod_pengosongan" id="v_prod_pengosongan" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>PROD-KARANTINA CIK, NP, LABEL: </b>
					        <input type="text" class="form-control"  name="v_prod_karantina" id="v_prod_karantina" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>PROD-CUTTING & SUPPLY CCT, TUBE: </b>
					        <input type="text" class="form-control"  name="v_prod_cutting" id="v_prod_cutting" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>QMP-TRIAL EC: </b>
					        <input type="text" class="form-control"  name="v_qmp_trial" id="v_qmp_trial" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>QMP-VALIDASI MATRIK INSPEKSI: </b>
					        <input type="text" class="form-control"  name="v_qmp_vld_mat" id="v_qmp_vld_mat" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>QMP-VALIDASI JIG: </b>
					        <input type="text" class="form-control"  name="v_qmp_vld_jig" id="v_qmp_vld_jig" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>ENGINEERING-SAO: </b>
					        <input type="text" class="form-control"  name="v_eng_sao" id="v_eng_sao" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>ENGINEERING-HOUSING: </b>
					        <input type="text" class="form-control"  name="v_eng_housing" id="v_eng_housing" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>ENGINEERING-JIG BOARD: </b>
					        <input type="text" class="form-control"  name="v_eng_jig" id="v_eng_jig" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>ENGINEERING-MATRIK: </b>
					        <input type="text" class="form-control"  name="v_eng_matrik" id="v_eng_matrik" disabled />
					      </div>
						</div>
					</div>
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
					    <div class="card">
					      <div class="card-header"> <b>ENGINEERING-SETTING MCL: </b>
					        <input type="text" class="form-control"  name="v_eng_setting" id="v_eng_setting" disabled />
					      </div>
						</div>
					</div>
