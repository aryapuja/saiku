	                ...
	                success : function(data){ 
	                    ...
	                    for(i=0; i<data.length; i++){ 
		                    ...
		                    html +=	
		                            ...
		                            '<td>'+
                                        '<a href="javascript:void(0);" id="detail" onclick="klikDetail()" class="btn btn-info btn-sm item_detail" data-id_dc="'+data[i].id_dc+'"data-nor="'+data[i].nor+'" data-no="'+data[i].no+'" data-rev="'+data[i].rev+'" data-item_changes="'+data[i].item_changes+'" data-start="'+data[i].start+'" data-carline="'+data[i].carline+'" data-de_epl="'+data[i].de_epl+'" data-de_com="'+data[i].de_com+'" data-de_eng="'+data[i].de_eng+'" data-pp_swct="'+data[i].pp_swct+'" data-pp_matrik="'+data[i].pp_matrik+'" data-qp_swct="'+data[i].qp_swct+'" data-qp_dwg="'+data[i].qp_dwg+'" data-qmp_trial="'+data[i].qmp_trial+'" data-qmp_vld_mat="'+data[i].qmp_vld_mat+'" data-qmp_vld_jig="'+data[i].qmp_vld_jig+'" data-eng_sao="'+data[i].eng_sao+'" data-eng_housing="'+data[i].eng_housing+'" data-eng_jig="'+data[i].eng_jig+'" data-eng_matrik="'+data[i].eng_matrik+'" data-eng_setting="'+data[i].eng_setting+'" data-nys_kb_cct="'+data[i].nys_kb_cct+'" data-nys_kb_material="'+data[i].nys_kb_material+'" data-nys_mcl="'+data[i].nys_mcl+'" data-prod_imp="'+data[i].prod_imp+'" data-prod_pengosongan="'+data[i].prod_pengosongan+'" data-prod_karantina="'+data[i].prod_karantina+'" data-prod_cutting="'+data[i].prod_cutting+'" data-ppc_req="'+data[i].ppc_req+'" data-ppc_release="'+data[i].ppc_release+'" >Detail</a> '+

                                        '<a href="javascript:void(0);" id="update" onclick="klikUpdate()" class="btn btn-warning btn-sm item_edit" data-id_dc="'+data[i].id_dc+'"data-nor="'+data[i].nor+'" data-no="'+data[i].no+'" data-rev="'+data[i].rev+'" data-item_changes="'+data[i].item_changes+'" data-start="'+data[i].start+'" data-end="'+data[i].end+'" data-carline="'+data[i].carline+'" data-de_epl="'+data[i].de_epl+'" data-de_com="'+data[i].de_com+'" data-de_eng="'+data[i].de_eng+'" data-pp_swct="'+data[i].pp_swct+'" data-pp_matrik="'+data[i].pp_matrik+'" data-qp_swct="'+data[i].qp_swct+'" data-qp_dwg="'+data[i].qp_dwg+'" data-qmp_trial="'+data[i].qmp_trial+'" data-qmp_vld_mat="'+data[i].qmp_vld_mat+'" data-qmp_vld_jig="'+data[i].qmp_vld_jig+'" data-eng_sao="'+data[i].eng_sao+'" data-eng_housing="'+data[i].eng_housing+'" data-eng_jig="'+data[i].eng_jig+'" data-eng_matrik="'+data[i].eng_matrik+'" data-eng_setting="'+data[i].eng_setting+'" data-nys_kb_cct="'+data[i].nys_kb_cct+'" data-nys_kb_material="'+data[i].nys_kb_material+'" data-nys_mcl="'+data[i].nys_mcl+'" data-prod_imp="'+data[i].prod_imp+'" data-prod_pengosongan="'+data[i].prod_pengosongan+'" data-prod_karantina="'+data[i].prod_karantina+'" data-prod_cutting="'+data[i].prod_cutting+'" data-ppc_req="'+data[i].ppc_req+'" data-ppc_release="'+data[i].ppc_release+'">Edit</a> '+
...
//  ===================  START UPDATE Record ===============================================
    ...
    //         });
        ...
                e.preventDefault(); 
        		...
        		var no 					= $('#v_no').val();
        		var rev 				= $('#v_rev').val();
        		var item_changes		= $('#v_item_changes').val();
        		var start 				= $('#v_start').val();
        		var end 				= $('#v_end').val();
        		var carline 			= $('#v_carline').val();
        		var color 				= $('#v_color').val();
				var de_epl 				= $('#v_de_epl').val();
        		var de_com 				= $('#v_de_com').val();
        		var de_eng 				= $('#v_de_eng').val();
        		var pp_swct 			= $('#v_pp_swct').val();
        		var pp_matrik 			= $('#v_pp_matrik').val();
        		var qp_swct 			= $('#v_qp_swct').val();
        		var qp_dwg 				= $('#v_qp_dwg').val();
        		var qmp_trial 			= $('#v_qmp_trial').val();
        		var qmp_vld_mat			= $('#v_qmp_vld_mat').val();
        		var qmp_vld_jig			= $('#v_qmp_vld_jig').val();
        		var eng_sao 			= $('#v_eng_sao').val();
        		var eng_housing			= $('#v_eng_housing').val();
        		var eng_jig 			= $('#v_eng_jig').val();
        		var eng_matrik 			= $('#v_eng_matrik').val();
        		var eng_setting 		= $('#v_eng_setting').val();
        		var nys_kb_cct 			= $('#v_nys_kb_cct').val();
        		var nys_kb_material 	= $('#v_nys_kb_material').val();
        		var nys_mcl 			= $('#v_nys_mcl').val();
        		var prod_imp 			= $('#v_prod_imp').val();
        		var prod_pengosongan	= $('#v_prod_pengosongan').val();
        		var prod_karantina 		= $('#v_prod_karantina').val();
        		var prod_cutting 		= $('#v_prod_cutting').val();
        		var ppc_req 			= $('#v_ppc_req').val();
        		var ppc_release 		= $('#v_ppc_release').val();
